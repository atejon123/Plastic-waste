...
```{r}
plastic_waste %>% 
  filter(total_pop < 310383948, plastic_waste_per_cap < 3) %>% 
  ggplot(aes(x = plastic_waste_per_cap, y = total_pop, colour = continent)) +
  geom_point()

plastic_waste %>% 
  filter(total_pop < 310383948, plastic_waste_per_cap < 3) %>% 
  ggplot(aes(x = plastic_waste_per_cap, y = coastal_pop, colour = continent)) +
  geom_point()
```
